...
struct scpi_opp_entry cpu_dvfs_tbl[] = {
	DVFS(100000000,  860 + 40),
	DVFS(250000000,  880 + 40),
	DVFS(500000000,  890 + 40),
	DVFS(667000000,  910 + 40),
	DVFS(1000000000,  960 + 40),
	DVFS(1200000000,  990 + 40),
	DVFS(1296000000,  1030 + 40),
	DVFS(1416000000,  1100 + 40),
};
